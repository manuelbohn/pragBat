...
For the CFA models reported above, we generate a continuous response variable for each task by z-transforming the proportion of correct responses for each task. An alternative perspective would be to treat the sum score as an ordinal variable. Below we  
...
We have to collapse several categories due to sparcity.
